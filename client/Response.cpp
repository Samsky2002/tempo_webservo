...
void Response::cgiHandle( const Request & request, int &kq )
{
...
void Response::setup( const Request & request, const ServerInfo & serverInfo, int &kq )
{
	try {
		if ( cgiExist ) {
			checkCgi( kq );
